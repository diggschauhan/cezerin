...
var Buttons = function (_React$Component) {
  ...
  _createClass(Buttons, [{
    ...
    value: function render() {
      ...
      var groupName = selected && selected.name && selected.name.length > 0 ? selected.name : 'Draft';
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _IconButton2.default,
          { touch: true, tooltipPosition: 'bottom-left', tooltip: _text2.default.customerGroups_titleAdd, onClick: onCreate },
          _react2.default.createElement(
            _FontIcon2.default,
            { color: '#fff', className: 'material-icons' },
            'add'
