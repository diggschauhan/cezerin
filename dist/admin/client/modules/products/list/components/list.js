  ...
  _createClass(ProductsList, [{
    ...
    value: function render() {
      ...
      var rows = items.map(function (item, index) {
        var itemSelected = selected.includes(item.id);
        return _react2.default.createElement(_item2.default, { key: index, product: item, selected: itemSelected, onSelect: onSelect, settings: settings });
      });
