...
var Buttons = function (_React$Component) {
  ...
  function Buttons(props) {
    ...
    _this.deleteGroup = function () {
      _this.setState({ openDelete: false });
      _this.props.onDelete(_this.props.shippingMethod.id);
    };
  ...
  _createClass(Buttons, [{
    ...
    value: function render() {
      ...
      var methodName = shippingMethod && shippingMethod.name && shippingMethod.name.length > 0 ? shippingMethod.name : 'Draft';
